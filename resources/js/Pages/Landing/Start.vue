            ...
            <div class="relative mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="flex text-white bg-stone-500/[.78] ">
                    <p
                        ...
                        </ChevronLeftIcon> <span class="inline-block -mb-4"></span>
                    </p>
                </div>
                <div class="flex flex-col px-10 py-8 space-y-4">
                    ...
                    <div class="flex w-full mt-1">
                        <img  class="object-cover w-2/3 h-3/5 rounded-xl" alt="">
                    </div>
                    ...
                    <div class="grow">
                        <p class="px-10 py-8 text-base font-semibold text-start">
