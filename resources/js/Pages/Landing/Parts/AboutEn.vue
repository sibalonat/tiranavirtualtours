...
<template>
    ...
    <p class="pr-4 mt-8 text-justify break-words text-body hyphens-auto text-virtual-blue">
        The city of Tirana has undergone significant transformations since the change of regimes in 1991. Until the mid-2000s, the development of contemporary art discourse in Albania was mainly being carried out by state-run institutions. However, by the latter part of the 2000s, independent initiatives started to emerge, becoming the primary actors in developing contemporary art discourse. The first edition of the Tirana Biennale took place in 2001.
        During the second Tirana Biennale in 2003, international artists were invited to paint the facades of buildings in the city. This action was initiated by Edi Rama, who was the mayor of Tirana at the time.
    </p>
    <p class="pr-4 mt-8 text-justify break-words text-body hyphens-auto text-virtual-blue">
